...
(defun menu-widget-selected-index (widget)
  "Return WIDGET's selected item index.

This value is internal selection state kept within WIDGET's item count and
...
This value tracks WIDGET's selected index and is updated together with it;
